-- LINE Harness OSS - Complete D1 Schema (All 42 Tables)
-- Run this on fresh D1 for full setup: wrangler d1 execute line-crm --file packages/db/schema-full.sql --remote
...
-- ============================================================
-- Internal UUID Users (Cross-Account)
-- ============================================================
...
-- ============================================================
-- LINE Account Management (Multi-Account)
-- ============================================================
...
-- ============================================================
-- Entry Routes (Ref Code -> Tag/Scenario)
-- ============================================================
...
-- ============================================================
-- Booking Reminders (予約リマインダー自動配信)
-- ============================================================
...
-- Auth: admin_users
-- Round 2: users, line_accounts, conversion_points, conversion_events, affiliates, affiliate_clicks
-- Round 3:
--   - Entry Routes: entry_routes, ref_tracking
...
--   - Templates: templates
--   - Chat: operators, chats
--   - Notifications: notification_rules, notifications
